...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{graphics/4-img.png}
\caption{Diagrama de flujo de la metodología de desarrollo iterativo aplicada en UrbanTracker}
\label{fig:metodologia-flujo}
\end{figure}
