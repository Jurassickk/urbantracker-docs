...
Por ejemplo, en sistemas de autobuses urbanos, los usuarios pueden esperar en paradas sin saber si el vehículo llegará pronto o si ha sufrido retrasos, lo que resulta en frustración y pérdida de tiempo valioso. Estudios indican que la desinformación contribuye a una reducción del 20-30% en la utilización del transporte público, exacerbando problemas ambientales y de movilidad urbana. Además, los administradores de flotas carecen de herramientas para monitorear eficientemente las rutas, lo que impide optimizaciones en la asignación de vehículos y la gestión de emergencias.
