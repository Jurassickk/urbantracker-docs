...
\begin{figure}[h]
\centering
\includegraphics[width=0.85\textwidth]{graphics/6-img.png}
\caption{Métricas de rendimiento de UrbanTracker: latencia, tasa de éxito, consumo de batería y tiempo de respuesta de API}
\label{fig:metricas-rendimiento}
\end{figure}
