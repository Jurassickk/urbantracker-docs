...
\item \textbf{Broker MQTT (Mosquitto)}: Centraliza y distribuye los mensajes de geolocalización de manera eficiente y rapidamente.
\item \textbf{Plataforma Web/Móvil (Suscriptores)}: Hace la funcionalidad de visualización de la información en tiempo real las posiciones de los vehículos para que los usuarios los pueda consultar y los administradores puedan gestionar el sistema.
\end{enumerate}
