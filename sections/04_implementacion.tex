...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.85\textwidth]{graphics/3-img.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.85\textwidth]{graphics/4-img.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.85\textwidth]{graphics/5-img.png}
...
Aquí tienes un fragmento del servicio de geolocalización que escribí en Spring Boot:
...
Este servicio básicamente recibe actualizaciones MQTT, las procesa y las vuelve a enviar a los clientes conectados. En el fondo es simple, pero fue un dolor de cabeza hacerlo funcionar bien. Yo mismo pasé horas depurándolo.
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.90\textwidth]{graphics/7-img.png}
...
Aquí tienes un pedazo del código React Native que escribí para capturar ubicación GPS:
...
Este componente básicamente pide permisos de ubicación, inicia el seguimiento GPS y publica coordenadas al broker MQTT cada vez que el dispositivo se mueve más de 10 metros. Los permisos son súper importantes - sin ellos la app no funciona nada. En mi experiencia, manejar permisos en móviles es crucial.
