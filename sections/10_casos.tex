...
\begin{figure}[h]
\centering
\includegraphics[width=0.85\textwidth]{graphics/10-img.png}
\caption{Resultados de escalabilidad: comparación de rendimiento del sistema con diferentes números de vehículos simultáneos}
\label{fig:escalabilidad-resultados}
\end{figure}
